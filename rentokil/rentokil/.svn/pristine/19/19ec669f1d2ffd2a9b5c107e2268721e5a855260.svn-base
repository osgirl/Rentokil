...
class Uploadhandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_url' => $this->get_full_url().'/files/',		// Not used now
            'user_dirs' => true,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'inline_file_types' => '/\.(xlsx|xls|csv)$/i',
    ...
    protected function get_user_id() {
        ...
        //return session_id();
        $date = new DateTime();
        return date("Y")."/" .date("M")."/".date("d")."/".$date->getTimestamp();
        //return date("Y")."/" .date("M")."/".date("d")."/".uniqid(); 
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $this->CI->session->set_userdata('UploadFilePath', $file_path);
        
        //$_SESSION['UploadFilePath'] = $file_path;
        return $file;
    }
    ...
    public function post($print_response = FALSE) {		// modified as "false" to hide file details
