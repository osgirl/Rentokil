...
<head>
	<meta charset="utf-8">
	<title>Facilities InSight application logs</title>
...
<body>
  <?php
		$scanned_directory = array_diff(scandir($this->config->item('log_path')), array('..', '.'));
    	...
    	foreach($scanned_directory as $key => $value)
    		echo '<p>' .anchor($pageURL.'/show_log_file/'.$value, $value);
